% !TEX root = main.tex
% quotes at chapter headings


\makeatletter
\newcommand{\wb@episource}{}
\newenvironment{wbepi}[1]{\begin{quote}\renewcommand{\wb@episource}{#1}\itshape }{\par\upshape \raggedleft --- {\wb@episource}\\ \end{quote}}
\makeatother

% Physics Library commands rewritten for tagging
\input{unicode-physics}

% Software citations from ApJ
\newcommand{\software}[1]{\textbf{\textit{Software: }} #1}

% Abstract environment for ease of import from ApJ
\renewenvironment{abstract}{\section*{Abstract}}{}
\newenvironment{acknowledgments}{\section*{Acknowledgments}}{}

% custom
\newcommand{\Mmsto}{$\rm M_{MSTO}$}
\newcommand{\Mrel}{$m_{\rm{rel}}$}
\newcommand{\age}{$\tau_{\rm{rel}}$}
...
\def\fesc{\textit{f$_{esc}$}}

%units
\newcommand{\Msun}{$\symrm{M_\odot}$}
\newcommand{\kms}{km~s$^{-1}$}
\newcommand{\OonH}{\ensuremath{12+\log(\symrm{O/H})}}
\newcommand{\f}{\emph{f}/}

\makeatletter
%Astrophysics journals - needed when using BiBTeX from NASA/ADS 
